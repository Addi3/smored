...
public class SmoredRecipeProvider extends FabricRecipeProvider {
    ...
    public SmoredRecipeProvider(FabricDataOutput output) {
        super(output);
    }
    ...
    private Identifier getStonecuttingIdentifier(Block in, Block out) {
        return Smored.id(fixupBlockKey(in.getTranslationKey()) + "_to_" + fixupBlockKey(out.getTranslationKey()) + "_stonecutting");
    }
