...
public class SmoredItems extends ItemContainer {
    ...
    @NoEnglish
    public static final Item MARSHMALLOW_ON_A_STICK = new MarshmallowOnAStickItem(new AItemSettings().group(SmoredItemGroups.MAIN).food(SmoredFoodComponenets.MARSHMALLOW).maxCount(1));

    @NoEnglish
    public static final Item MARSHMALLOW_SLIGHTLY_ROASTED_ON_A_STICK = new MarshmallowOnAStickItem(new AItemSettings().food(SmoredFoodComponenets.MARSHMALLOW_COOKED).maxCount(1));

    @NoEnglish
    public static final Item MARSHMALLOW_PERFECTLY_ROASTED_ON_A_STICK = new MarshmallowOnAStickItem(new AItemSettings().food(SmoredFoodComponenets.MARSHMALLOW_COOKED).maxCount(1));

    @NoEnglish
    public static final Item MARSHMALLOW_BURNT_ON_A_STICK = new MarshmallowOnAStickItem(new AItemSettings().food(SmoredFoodComponenets.MARSHMALLOW_BURNT).maxCount(1));
